; ModuleID = 'simpleArray.c'
source_filename = "simpleArray.c"
...
define i32 @main() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 4)
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 5)
  ret i32 0
}
