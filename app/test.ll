; ModuleID = 'testMain.c'
source_filename = "testMain.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.15.0"

@.str = private unnamed_addr constant [15 x i8] c" %f + %f = %f\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %10 = call double @func(double %8, double %9)
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), double %6, double %7, double %10)
  %12 = load double, double* %3, align 8
  %13 = call double @llvm.pow.f64(double %12, double 2.000000e+00)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), double %13)
  ret i32 0
}
...
declare double @func(double, double) #2
