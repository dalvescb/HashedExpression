...
define double @test28(double %w, double %x, double %y) {
entry:
  %t1412448959768072 = call double @llvm.pow.f64(double %x, double -1.000000e+00)
  %t1257276397486830 = fmul double %w, %t1412448959768072
  %t1513173470626744 = call double @llvm.pow.f64(double %y, double -1.000000e+00)
  %t1183343689635350 = fmul double %t1257276397486830, %t1513173470626744
  ret double %t1183343689635350
}
