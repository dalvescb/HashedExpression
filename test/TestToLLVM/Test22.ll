...
define double @test22(double %w, double %x, double %y) {
entry:
  %t991235056200937 = fadd double %w, %x
  %t999447443335284 = fadd double %t991235056200937, %y
  ret double %t999447443335284
}
